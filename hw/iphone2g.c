...
uint32_t g_debug_s5l8900 = ( 0 //S5L8900_DEBUG_CLK
                    //0xffffffff |
                    );
uint32_t g_dlevel_s5l8900 = 0;
FILE *g_debug_fp_s5l8900 = NULL;
                ...
                const char *initrd_filename, const char *cpu_model)
{
	...
	if(!get_image_size(option_rom[1].name))
	{
    ...
    load_image_targphys(option_rom[1].name, iboot_base, iboot_size);
