...
extern uint32_t g_debug_s5l8900;
extern uint32_t g_dlevel_s5l8900;
extern FILE *g_debug_fp_s5l8900;
...
#define S5L8900_DEBUG(module, level, msg ...)                              \
    do {                                                                \
    if ((module) & g_debug_s5l8900 || (level) <= g_dlevel_s5l8900) {                \
        fprintf(g_debug_fp_s5l8900, "%lld : ", qemu_get_clock_ms(vm_clock));    \
            fprintf(g_debug_fp_s5l8900, msg);                                   \
        }                                                               \
    } while (0)
